...
public class Departamento implements Serializable {
    ...
    public Departamento(Integer codDepartamento, String nombre, boolean status) {
        this.codDepartamento = codDepartamento;
        this.nombre = nombre;
        this.status = status;
    }
    ...
    public String toString() {
        return "com.repo.uca.entities.Departamento[ codDepartamento=" + codDepartamento + " ]";
    }
